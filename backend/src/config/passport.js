...
passport.use(new GoogleStrategy({
    ...
    callbackURL: `${env.clientUrl}/api/auth/google/callback`
  },
  async (accessToken, refreshToken, profile, done) => {
    try {
      ...
      user = await User.findOne({ email: await cryptoService.encryptField(email, 'RSA', 'USER_PROFILE') });
      ...
      user = await User.create({
        ...
        accountStatus: ACCOUNT_STATUS.ACTIVE, // Skip OTP for Google users
